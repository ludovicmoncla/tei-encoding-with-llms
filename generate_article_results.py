...
def main() -> None:
    ...
    plot_prompt1_entry_metrics_for_model(
        entry_rows,
        documents,
        figures_dir / "fs_relatedentry_precision_recall_microf1_gemini-3.1-flash-lite-preview.png",
    ...
    plot_prompt1_entry_metrics_for_model(
        entry_rows,
        documents,
        figures_dir / "fs_mainentry_precision_recall_microf1_gemini-3.1-flash-lite-preview.png",
        model="gemini-3.1-flash-lite-preview",
        prompt="FS",
        element="mainEntry",
    )
    plot_prompt1_entry_metrics_for_model(
        entry_rows,
        documents,
        figures_dir / "fs_relatedentry_precision_recall_microf1_gpt-5.4-mini.png",
        model="gpt-5.4-mini",
        prompt="FS",
        element="relatedEntry",
    )
    plot_prompt1_entry_metrics_for_model(
        entry_rows,
        documents,
        figures_dir / "fs_mainentry_precision_recall_microf1_gpt-5.4-mini.png",
        model="gpt-5.4-mini",
        prompt="FS",
        element="mainEntry",
    )
